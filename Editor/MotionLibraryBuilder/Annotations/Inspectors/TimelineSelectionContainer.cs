...
namespace Unity.Kinematica.Editor
{
    class TimelineSelectionContainer : ScriptableObject
    {
        ...
        public IEnumerable<MarkerAnnotation> Markers
        {
        ...
        void OnClipDataChanged()
        {
            ...
            int markersBefore = Clip.Markers.Count();
            int tagsBefore = Clip.Tags.Count();
            ...
            if (markersBefore != Clip.Markers.Count || tagsBefore != Clip.Tags.Count)
            {
                AnnotationsChanged?.Invoke();
            }
        }
